...
class CreateWarrantyJobPackageProductTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warranty_job_package_product', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('warranty_job_package_product');
    }
}
