                        ...
                        @foreach($discounts as $discount)
                            <tr>
                                ...
                                <td class="pull-right">
                                    ...
                                    <button onclick="showModal({{$discount->id}})" type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Deactivate record">
                    ...
                    <tbody>
                        @foreach($deactivate as $discount)
                            <tr>
                                ...
                                <td class="pull-right">
                                    <button onclick="show({{$discount->id}})"type="button" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Reactivate record">
