                        ...
                        @foreach($brands as $brand)
                            <tr>
                                ...
                                <td class="pull-right">
                                    ...
                                    <button onclick="showModal({{$brand->id}})" type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Deactivate record">
                    ...
                    <tbody>
                        @foreach($deactivate as $brand)
                            <tr>
                                ...
                                <td class="pull-right">
                                    <button onclick="show({{$brand->id}})"type="button" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Reactivate record">
