<ul id="form-elements" style="display: none">
      ...
      <li class="form-element" id="form-settings-element" data-type="form-settings">
        <h4 id="form-title-label">{title}</h4>
        <h6 id="form-description-label">{description}</h6>
      </li>

      <li>
        <ul id="sortable-elements" style="margin-top:-3%;">

          {#fields}

            <!-- Email -->

            {@eq key="{type}" value="element-email"} 

              <li class="form-element {#required}required{/required}" id="element-{position}" data-label="{title}" data-position="{position}" data-type="element-email">
                <label>
            ...
            {@eq key="{type}" value="element-dropdown"}
              ...
              <li class="form-element {#required}required{/required}" id="element-{position}" data-label="{title}" data-position="{position}" data-type="element-dropdown">
                ...
                <select style="width: 50%" class="choices form-control" data-type="settings-dropdown" disabled>
    ...
    <button id="save" class="btn button btn-success">Save Form</button>