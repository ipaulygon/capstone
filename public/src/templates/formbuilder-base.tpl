                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="add-field">
                        <div style="margin-top:15%">
                            <a href = "#save" class=" new-element btn smoothScroll btn-field btn-field-2 btn-social" data-type="element-single-line-text">Text Field
                                <i class="fa fa-font"></i>
                            </a>
                            <a href = "#save" class="button new-element waves-effect waves-light btn smoothScroll btn-field btn-field-1 btn-social" data-type="element-paragraph-text">Paragraph Text
                                <i class="fa fa-align-justify"></i>
                            </a>
                            <a href = "#save" class="button new-element waves-effect waves-light btn smoothScroll btn-field btn-field-1 btn-social" data-type="element-multiple-choice">Radio Button
                            ...
                            <a href = "#save" class="button new-element waves-effect waves-light btn smoothScroll btn-field btn-field-1 btn-field-3 btn-social" data-type="element-dropdown">Dropdown
